...
(function() {
    ...
    function K(v) {
        ...
        function R(a, b, c, e, f) {
            var g = Math.min, h = Math.max, j = [], k, m = a.length, p, r = b.length, u = r - m || 1, F = m + r + 1, I, z, y;
            for (k = 0; k <= m; k++) {
                z = I;
                j.push(I = []);
                y = g(r, k + u);
        ...
        function S(a, d, c, e, f) {
            ...
            g && (T(c, e),
            f.afterRender && b.r.K(f.afterRender, n, [c, e.$data]));
            return c
        }
        function M(a) {
                ...
                if (j = ("function" == typeof d ? d(m, a) : d) || b.J.instance.getBindings(a, m)) {
                    if (0 === h) {
                        ...
                        for (var r in j) {
                            ...
                            if (u && "function" == typeof u.init && (u = (0,
                            u.init)(a, f(r), g, p, m)) && u.controlsDescendantBindings)
                    ...
                    if (2 === h)
                        for (r in j)
                            (u = b.c[r]) && "function" == typeof u.update && (0,
                            u.update)(a, f(r), g, p, m)
                }
            }, n, {
                W: a
            });
            ...
            b.c[a] = {
                ...
                update: function(a, g, h, j, k) {
                    ...
                    if (m || d || j !== h.pb)
                        ...
                        j ? (m || b.e.N(a, b.a.Ha(h.Ya)),
                        b.Da(e ? e(k, g) : k, a)) : b.e.Y(a),
                        h.pb = j
                }
            };
            b.g.Q[a] = q;
        ...
        b.a = new function() {
            ...
            for (g = f.getElementsByTagName("i"); f.innerHTML = "<\!--[if gt IE " + ++c + "]><i></i><![endif]--\>",
            g[0]; )
                ;
            m = 4 < c ? c : H;
            return {
                ...
                n: function(b, d, c) {
                    ...
                    if (!e && "undefined" != typeof E) {
                        ...
                        !e && "function" == typeof b.addEventListener ? b.addEventListener(d, c, q) : "undefined" != typeof b.attachEvent ? b.attachEvent("on" + d, function(a) {
                            c.call(b, a)
                ...
                Aa: function(b, d) {
                    ...
                    if ("undefined" != typeof E) {
                        ...
                        "function" == typeof x.createEvent ? "function" == typeof b.dispatchEvent ? (c = x.createEvent(e[d] || "HTMLEvents"),
                        c.initEvent(d, l, l, w, 0, 0, 0, 0, 0, q, q, q, q, 0, b),
                        b.dispatchEvent(c)) : i(Error("The supplied element doesn't support dispatchEvent")) : "undefined" != typeof b.fireEvent ? (a(b, d) && (b.checked = b.checked !== l),
                        b.fireEvent("on" + d)) : i(Error("Browser doesn't support triggering events"))
                },
                d: function(a) {
                    return b.$(a) ? a() : a
                },
                ...
                vb: function(a) {
                    9 <= m && (a = 1 == a.nodeType ? a : a.parentNode,
        ...
        b.a.ca = function(a, d) {
            ...
            if (d !== n && d !== H)
                ...
                "undefined" != typeof E)
                    ...
                    for (var c = b.a.sa(d), e = 0; e < c.length; e++)
                        a.appendChild(c[e])
        }
        ;
        ...
        b.j = function(a, d, c) {
            ...
            function h() {
                if (0 < arguments.length)
                    return "function" === typeof u ? u.apply(d, arguments) : i(Error("Cannot write a value to a ko.computed unless you specify a 'write' option. If you wish to read the current value, don't pass any parameters.")),
                    this;
                m || g();
                b.r.Va(h);
                return k
        ...
        b.g = {
            ...
            aa: function(a) {
                ...
                for (f = d.length; c < f; c++)
                    j = d[c],
                    k = j.indexOf(":"),
                    0 < k && k < j.length - 1 ? (g = j.substring(k + 1),
                    e.push({
            ...
            ba: function(a) {
                for (var d = "string" === typeof a ? b.g.aa(a) : a, c = [], a = [], e, f = 0; e = d[f]; f++)
                    ...
                    e.key) {
                        ...
                        e && (0 < a.length && a.push(", "),
                        a.push(g + " : function(__ko_value) { " + e + " = __ko_value; }"))
                    } else
            ...
            update: function(a, d) {
                ...
                for (e in c)
                    if ("string" == typeof e) {
                        ...
                        8 >= b.a.Z && e in ea ? (e = ea[e],
                        g ? a.removeAttribute(e) : a[e] = f) : g || a.setAttribute(e, f.toString());
        ...
        b.c.checked = {
            init: function(a, d, c) {
                b.a.n(a, "click", function() {
                    ...
                    var f = d()
                      , g = b.a.d(f);
                    "checkbox" == a.type && g instanceof Array ? (e = b.a.i(g, a.value),
                    a.checked && 0 > e ? f.push(a.value) : !a.checked && 0 <= e && f.splice(e, 1)) : b.g.ea(f, c, "checked", e, l)
                });
        ...
        b.c.hasfocus = {
            ...
            update: function(a, d) {
                var c = b.a.d(d());
                a.__ko_hasfocusUpdating || (c ? a.focus() : a.blur(),
            ...
            update: function(a, d, c) {
                ...
                if (h) {
                    ...
                    for (m = h.length; d < m; d++)
                        0 <= b.a.i(f, b.k.q(h[d])) && (b.a.ab(h[d], l),
                        j++);
                    a.scrollTop = g;
        ...
        b.pa = function() {
            ...
            this.renderTemplateSource = function(b, c, e) {
                ...
                f || (f = b.text() || "",
                f = E.template(n, "{{ko_with $item.koBindingContext}}" + f + "{{/ko_with}}"),
