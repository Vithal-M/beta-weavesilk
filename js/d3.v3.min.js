d3 = function() {
    ...
    function w(n) {
        ...
        return function(e, r) {
            ...
            r ? (t.lastIndex = 0,
            t.test(u) || e.setAttribute("class", M(u + " " + n))) : e.setAttribute("class", M(u.replace(t, " ")))
        }
    }
    function S(n, t, e) {
        function r() {
    ...
    function ut(n, t, e) {
        ...
        return (i = Za.get(n)) ? t(i.r, i.g, i.b) : (null != n && n.charAt(0) === "#" && (n.length === 4 ? (a = n.charAt(1),
        a += a,
        o = n.charAt(2),
        o += o,
        c = n.charAt(3),
        ...
        e.parseRows = function(n, t) {
            function e() {
                ...
                if (n.charCodeAt(t) === 34) {
                    ...
                    return 13 === r ? (u = !0,
                    n.charCodeAt(e + 2) === 10 && ++f) : 10 === r && (u = !0),
    ...
    function gt() {
        for (var n, t = Date.now(), e = Ka; e; )
            ...
            e = e.next;
        var r = pt() - t;
        r > 24 ? (isFinite(r) && (clearTimeout($a),
        $a = setTimeout(gt, r)),
        Ba = 0) : (Ba = 1,
        Wa(gt))
    }
    function pt() {
        for (var n = null, t = Ka, e = 1 / 0; t; )
            t.flush ? (delete Ga[t.callback.id],
            t = n ? n.next = t.next : Ka = t.next) : (e = Math.min(e, t.then + t.delay),
            t = (n = t).next);
        return e
    }
    function dt(n, t) {
        ...
        return function(r) {
            ...
            var s, h, g, p, d, m = t(r), v = {
                ...
                polygonEnd: function() {
                    ...
                    v.lineEnd = o,
                    s = oa.merge(s),
                    s.length ? Ft(s, Ut, null, e, r) : (-Fa > h || p && -Fa > g) && (r.lineStart(),
                    e(null, null, 1, r),
                    r.lineEnd()),
                    r.polygonEnd(),
                    s = null
    ...
    function Yt(n, t) {
        ...
        for (var e, r, u, i = 0, a = 0, o = n[0], c = o[0], l = o[1], f = Math.cos(l), s = Math.atan2(t * Math.sin(c) * f, Math.sin(l)), h = 1 - t * Math.cos(c) * f, g = s; ++i < e; )
            ...
            u = 1 - t * Math.cos(c) * f,
            Math.abs(h - 2) < Fa && Math.abs(u - 2) < Fa || (Math.abs(u) < Fa || Math.abs(h) < Fa || (Math.abs(Math.abs(r - s) - La) < Fa ? u + h > 2 && (a += 4 * (r - s)) : a += Math.abs(h - 2) < Fa ? 4 * (r - g) : ((3 * La + r - s) % (2 * La) - La) * (h + u)),
            g = s,
            s = r,
            h = u);
        return a
    ...
    function It(n) {
        ...
        return {
            ...
            point: function(i, a) {
                var o = i > 0 ? La : -La
                  , c = Math.abs(i - e);
                Math.abs(c - La) < Fa ? (n.point(e, r = (r + a) / 2 > 0 ? La / 2 : -La / 2),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(o, r),
                n.point(i, r),
                t = 0) : u !== o && c >= La && (Math.abs(e - u) < Fa && (e -= u * Fa),
    ...
    function Zt(n) {
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                E = k,
                k = _),
                N ? q ? E + k > 0 ^ b[1] < (Math.abs(b[0] - w) < Fa ? E : k) : E <= b[1] && b[1] <= k : A > La ^ (w <= b[0] && b[0] <= S)) {
                    var T = Ct(m, (-v + x) / y);
                    return Tt(T, p),
                    [b, jt(T)]
                }
    ...
    function Bt(n, t, e, r) {
        ...
        function o(u, i) {
            var a = i[0] - u[0]
              , o = i[1] - u[1]
              , c = [0, 1];
            return Math.abs(a) < Fa && Math.abs(o) < Fa ? n <= u[0] && u[0] <= e && t <= u[1] && u[1] <= r : $t(n - u[0], a, c) && $t(u[0] - e, -a, c) && $t(t - u[1], o, c) && $t(u[1] - r, -o, c) ? (c[1] < 1 && (i[0] = u[0] + c[1] * a,
            i[1] = u[1] + c[1] * o),
            c[0] > 0 && (u[0] += c[0] * a,
            u[1] += c[0] * o),
            !0) : !1
        ...
        return function(c) {
            ...
            var y, M, x, _, w, S, E, k, A, q, N = c, T = Ot(), C = {
                point: p,
                lineStart: d,
                lineEnd: m,
                polygonStart: function() {
                ...
                polygonEnd: function() {
                    c = N,
                    (y = oa.merge(y)).length ? (c.polygonStart(),
                    Ft(y, i, l, h, c),
    ...
    function Wt(n) {
        ...
        ,
        t.center = function(n) {
            return arguments.length ? (g = n[0] % 360 * Ha,
            p = n[1] % 360 * Ha,
            r()) : [g * Pa, p * Pa]
        }
        ,
        t.rotate = function(n) {
            return arguments.length ? (d = n[0] % 360 * Ha,
            m = n[1] % 360 * Ha,
    ...
    function ie(n, t) {
        ...
        return function(u, i, a, o) {
            null != u ? (u = ae(e, u),
            i = ae(e, i),
            (a > 0 ? i > u : u > i) && (u += 2 * a * La)) : (u = n + 2 * a * La,
            i = n);
    ...
    function Ce(n) {
        ...
        t.interpolate = function(n) {
            return arguments.length ? (a = "function" == typeof n ? i = n : (i = Do.get(n) || je).key,
            t) : a
        }
        ,
    ...
    function Re(n, t) {
        return n.length < 3 ? je(n) : n[0] + Ye((n.push(n[0]),
        n), Ue([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function Oe(n, t) {
    ...
    function Ye(n, t) {
        ...
        var e = n.length != t.length
          ...
          , o = a
          , c = 1;
        if (e && (r += "Q" + (i[0] - a[0] * 2 / 3) + "," + (i[1] - a[1] * 2 / 3) + "," + i[0] + "," + i[1],
        u = n[1],
        c = 2),
        t.length > 1) {
            o = t[1],
    ...
    function Nr(n, t) {
        ...
        arguments.length ? e = t / (2 * La) * Math.asin(1 / n) : (n = 1,
        e = t / 4),
        function(r) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            l > 2))
                ...
                a = 3; l > a; a++) {
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== o._pack_prev && !_u(c, i); c = c._pack_prev,
                        m++)
                            ;
                    p ? (m > d || d == m && u.r < r.r ? bu(r, u = o) : bu(r = c, u),
                    a--) : (xu(r, i),
                    u = i,
                    t(i))
                }
    ...
    function Xu(n, t, e, r) {
        ...
        ,
        u.domain = function(t) {
            return arguments.length ? (t[0] < 0 ? (e = $u,
            r = Ju) : (e = Zu,
            r = Bu),
            n.domain(t.map(e)),
            u) : n.domain().map(r)
        ...
        u.tickFormat = function(n, i) {
            if (arguments.length < 2 && (i = $o),
            !arguments.length)
                return i;
            var a, o = Math.log(t), c = Math.max(.1, n / u.ticks().length), l = e === $u ? (a = -1e-12,
            Math.floor) : (a = 1e-12,
            Math.ceil);
            return function(n) {
    ...
    function li(n) {
        ...
        ,
        t.interpolate = function(n) {
            return arguments.length ? (c = "function" == typeof n ? o = n : (o = Do.get(n) || je).key,
            l = o.reverse || o,
            f = o.closed ? "M" : "L",
            t) : c
        }
    ...
    function zi(n, t, e) {
        ...
        return r ? (n.m = Ac.get(r[0].toLowerCase()),
        e += r[0].length) : -1
    }
    function Di(n, t, e) {
        Sc.lastIndex = 0;
        var r = Sc.exec(t.substring(e));
        return r ? (n.m = Ec.get(r[0].toLowerCase()),
        e += r[0].length) : -1
    }
    function ji(n, t, e) {
    ...
    oa.behavior.drag = function() {
        ...
        function t() {
            ...
            function u() {
                ...
                g && (l(),
                oa.event.target === f && p.on("click.drag", i, !0)),
    ...
    Ea.selectAll = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i; )
            for (var a = this[u], o = -1, c = a.length; ++o < c; )
                (e = a[o]) && (r.push(t = va(n.call(e, e.__data__, o))),
                t.parentNode = e);
        return d(r)
    }
    ;
    ...
    oa.behavior.zoom = function() {
        ...
        return n.translate = function(t) {
            return arguments.length ? (_ = t.map(Number),
            i(),
            n) : _
        }
        ,
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (S = null == t ? za : t.map(Number),
            n) : S
        }
        ,
        n.x = function(t) {
    ...
    Xa.brighter = function(n) {
        ...
        e && u > e && (e = u),
        r && u > r && (r = u),
        tt(Math.min(255, Math.floor(t / n)), Math.min(255, Math.floor(e / n)), Math.min(255, Math.floor(r / n)))) : tt(u, u, u)
    }
    ,
    ...
    oa.xhr = function(n, t, e) {
        ...
        ,
        oa.rebind(u, i, "on"),
        arguments.length === 2 && "function" == typeof t && (e = t,
        t = null),
        null == e ? u : u.get(st(e))
    }
    ,
    ...
    oa.geo.circle = function() {
        ...
        ,
        n.angle = function(r) {
            return arguments.length ? (e = ie((t = +r) * Ha, u * Ha),
            n) : t
        }
        ,
        n.precision = function(r) {
            return arguments.length ? (e = ie(t * Ha, (u = +r) * Ha),
            n) : u
        }
        ,
        n.angle(90)
    ...
    oa.geo.path = function() {
        ...
        n.projection = function(e) {
            return arguments.length ? (r = (t = e) ? e.stream || Se(e) : ft,
            n) : t
        }
        ,
        n.context = function(t) {
            return arguments.length ? (u = (e = t) == null ? new ve : new _e(t),
            n) : e
        }
        ,
    ...
    oa.geom.polygon = function(n) {
        ...
        n.clip = function(t) {
            for (var e, r, u, i, a, o, c = -1, l = n.length, f = n[l - 1]; ++c < l; ) {
                ...
                r = -1; ++r < u; )
                    o = e[r],
                    nr(o, f, i) ? (nr(a, f, i) || t.push(tr(a, o, f, i)),
                    t.push(o)) : nr(a, f, i) && t.push(tr(a, o, f, i)),
                    a = o;
                f = i
            }
            return t
    ...
    oa.geom.voronoi = function(n) {
                ...
                if (!(r > 2)) {
                    ...
                    if (Math.abs(d) < Fa) {
                        ...
                        var m = (l - o) * (g - f) > (h - l) * (f - c) ? s : -s
                          , y = Math.abs(d) - p;
                        Math.abs(y) < Fa ? n.push([0 > d ? m : -m, m]) : (y > 0 && (m *= -1),
                        n.push([-s, m], [s, m]))
                    }
                }
            }),
        ...
        t.size = function(n) {
            ...
            e = oa.geom.polygon([[0, 0], [0, r[1]], r, [r[0], 0]]).clip),
            t) : r
        }
        ,
        t.links = function(n) {
    ...
    oa.geom.quadtree = function(n, t, e, r, u) {
        ...
        var a, o = ze, c = De;
        return (a = arguments.length) ? (o = rr,
        c = ur,
        3 === a && (u = e,
        r = t,
        e = t = 0),
    ...
    var Ro = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    oa.interpolate = mr,
    oa.interpolators = [pr, function(n, t) {
    ...
    oa.layout.force = function() {
        ...
        return o.tick = function() {
            ...
            y))
                for (; ++e < b; )
                    ...
                    o.y += (x - o.y) * y;
            if (g)
                for (Xr(t = oa.geom.quadtree(m), r, a),
                e = -1; ++e < b; )
        ...
        o.drag = function() {
            ...
            arguments.length ? (this.on("mouseover.force", Ir).on("mouseout.force", Vr).call(e),
            void 0) : e
        }
        ,
        oa.rebind(o, c, "on")
    ...
    oa.layout.stack = function() {
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Zo.get(t) || nu,
            n) : e
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Bo.get(t) || tu,
            n) : r
        }
        ,
        n.x = function(t) {
    ...
    oa.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i = -1; ++i < h; )
                    o = l[i],
                    o >= f[0] && o <= f[1] && (a = c[oa.bisect(s, o, 1, g) - 1],
                    a.y += p,
                    a.push(n[i]));
            return c
        }
    ...
    oa.layout.tree = function() {
        function n(n, u) {
            ...
            function o(n, t, r) {
                if (t) {
                    for (var u, i = n, a = n, o = t, c = n.parent.children[0], l = i._tree.mod, f = a._tree.mod, s = o._tree.mod, h = c._tree.mod; o = fu(o),
                    i = lu(i),
                    o && i; )
                        c = lu(c),
                        a = fu(a),
    ...
    oa.layout.treemap = function() {
        ...
        function e(t) {
            ...
            if (r && r.length) {
                ...
                c.area = 0; i = o.pop(); )
                    c.push(i),
                    c.area += i.area,
                    i.z != null && (u(c, i.z ? a.dx : a.dy, a, !o.length),
                    c.length = c.area = 0);
                r.forEach(e)
            }
        }
        ...
        i.padding = function(n) {
            ...
            if (!arguments.length)
                return f;
            var r;
            return s = (f = n) == null ? zu : (r = typeof n) == "function" ? t : "number" === r ? (n = [n, n, n, n],
            e) : e,
            i
        }
        ,
    ...
    var ec, rc = Math.sqrt(3), uc = Math.tan(30 * Ha), ic = [], ac = 0, oc = {
        ease: Sr,
        delay: 0,
        duration: 250
    };
    ...
    oa.svg.axis = function() {
        function n(n) {
            n.each(function() {
                ...
                oa.transition(S)), k = e.copy(), A = this.__chart__ || k;
                this.__chart__ = k,
                x.append("line"),
                x.append("text");
                var q = x.select("line")
        ...
        ,
        n.orient = function(t) {
            return arguments.length ? (r = t in lc ? t + "" : cc,
            n) : r
        }
        ,
        n.ticks = function() {
    ...
    oa.svg.brush = function() {
        ...
        function u() {
            ...
            function s() {
                oa.event.keyCode == 32 && 2 == E && (k[0] += h[1][0],
                k[1] += h[1][1],
                E = 0,
                l())
            }
            function g() {
                ...
                v && (n[0] += v[0],
                n[1] += v[1]),
                E || (oa.event.altKey ? (m || (m = [(h[0][0] + h[1][0]) / 2, (h[0][1] + h[1][1]) / 2]),
                k[0] = h[+(n[0] < m[0])][0],
                k[1] = h[+(n[1] < m[1])][1]) : m = null),
                w && p(n, o, 0) && (e(b),
                i = !0),
                S && p(n, c, 1) && (r(b),
                i = !0),
        ...
        var i, a = s(n, "brushstart", "brush", "brushend"), o = null, c = null, f = sc[0], h = [[0, 0], [0, 0]];
